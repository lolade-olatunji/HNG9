		...
		<div id="contact-page">
            ...
            <div className="form-inline">
              <div className="form-control first">
                ...
                <input className="form-input" type="text" id="first-name"  placeholder="Enter your first name"/>
              </div>

              <div className="form-control last">
                <label className="form-label" for="Last-Name">Last Name</label>
                <input className="form-input" type="text" id="Last-Name"  placeholder="Enter your last name" />
              </div>
            </div>
            ...
            <div className="form-control">
            <label className="form-label" for="Meesage">Message</label>
            <textarea name="Message" rows="6" placeholder="Send me a message and I'll reply you as soon as possible"></textarea>
            </div>
            </div>
			</div>
      <Footer />
